...
const DEFAULT_BATTLE_SCENE_PATH := "res://game/battle/scenes/battle_scene.tscn"
const DEFAULT_RETURN_SCENE_PATH := "res://game/world/levels/new_bouffalant_city/new_bouffalant_city.tscn"
...
## progression survives scene changes for the current play session; repeatable
## challenge-area opponents opt into Highly Aggro mode and deliberately ignore it.
