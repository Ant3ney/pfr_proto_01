...
const ROUTE_SCENE := preload("res://game/world/levels/standalone_areas/routes/route_00/route_00.tscn")
const WILD_BATTLE_SCENE_PATH := "res://game/battle/scenes/route_0_wild_battle_scene.tscn"
const WILD_ENCOUNTER_PATH := "res://game/battle/encounters/wild_fletchling_route_0_v1.tres"
...
func _run() -> void:
	...
	if route == null:
		_finish()
		return
	var route_trainers := route.get_node_or_null(^"Gameplay/Actors/RouteTrainers") as Node3D
	...
	var return_gateway := route.get_node_or_null(^"Gameplay/Transitions/Route0ReturnGateway") as AreaGateway
