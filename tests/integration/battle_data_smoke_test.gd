...
const EncounterDefinition := preload("res://game/battle/encounters/battle_encounter_definition.gd")
const EncounterMember := preload("res://game/battle/encounters/battle_encounter_member.gd")
const KYLE_ENCOUNTER_PATH := "res://game/battle/encounters/trainer_kyle_lake_v1.tres"
const KYLE_SCENE_PATH := "res://game/battle/scenes/kyle_battle_scene.tscn"
const KYLE_TRAINER_SCENE_PATH := "res://game/actors/npcs/trainers/presets/trainer_kyle.tscn"
...
const CITY_LINEUP_TRAINER_SPECS := [
	{
		...
		"encounter_path": "res://game/battle/encounters/trainer_police_officer_city_v1.tres",
		"battle_scene_path": "res://game/battle/scenes/police_officer_battle_scene.tscn",
		"trainer_scene_path": "res://game/actors/npcs/trainers/presets/trainer_police_officer.tscn",
		"team_size": 2,
	},
	{
		"label": "Businessman",
		"encounter_id": "trainer-businessman-city-v1",
		"encounter_path": "res://game/battle/encounters/trainer_businessman_city_v1.tres",
		"battle_scene_path": "res://game/battle/scenes/businessman_battle_scene.tscn",
		"trainer_scene_path": "res://game/actors/npcs/trainers/presets/trainer_businessman.tscn",
		"team_size": 2,
	},
	{
		"label": "Backpacker",
		"encounter_id": "trainer-backpacker-city-v1",
		"encounter_path": "res://game/battle/encounters/trainer_backpacker_city_v1.tres",
		"battle_scene_path": "res://game/battle/scenes/backpacker_battle_scene.tscn",
		"trainer_scene_path": "res://game/actors/npcs/trainers/presets/trainer_backpacker.tscn",
		"team_size": 2,
	},
	{
		"label": "Jogger",
		"encounter_id": "trainer-jogger-city-v1",
		"encounter_path": "res://game/battle/encounters/trainer_jogger_city_v1.tres",
		"battle_scene_path": "res://game/battle/scenes/jogger_battle_scene.tscn",
		"trainer_scene_path": "res://game/actors/npcs/trainers/presets/trainer_jogger.tscn",
		"team_size": 1,
	},
	{
		"label": "Tourist",
		"encounter_id": "trainer-tourist-city-v1",
		"encounter_path": "res://game/battle/encounters/trainer_tourist_city_v1.tres",
		"battle_scene_path": "res://game/battle/scenes/tourist_battle_scene.tscn",
		"trainer_scene_path": "res://game/actors/npcs/trainers/presets/trainer_tourist.tscn",
		"team_size": 2,
	},
]
