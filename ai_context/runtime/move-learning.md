...
[`generate_move_learnsets.mjs`](../../tools/creatures/generate_move_learnsets.mjs)
derives the compact
...
[`MoveLearnsetCatalog`](../../game/progression/move_learning/move_learnset_catalog.gd)
...
[`MoveLearningSystem.gd`](../../game/progression/move_learning/move_learning_system.gd). It
...
[`MoveLearningUI`](../../game/progression/move_learning/move_learning_ui.gd) blocks play and
...
[`BattleScene`](../../game/battle/scenes/battle_scene.gd) awaits all pending choices for that
...
The focused test covers exact-form and fallback catalog selection, crossed
...
restoration, queue validation, and pending-choice save restoration. Keep the
implementation under `game/progression/move_learning/` and preserve its
autoload, battle-presentation, autosave, export, test, and context boundaries.
