...
| Change the project entry scene, main menu, Cypress introduction, Route 0 menu camera, Continue handoff, or first gameplay placement | [`startup-flow.md`](startup-flow.md) | Startup-controller ownership, isolated live backdrop, input/layout behavior, save inspection, retry, and gameplay-entry boundaries |
...
| Change first-run starter selection, fresh-profile initialization, or full progress reset | [`starter-selection.md`](starter-selection.md) | Exact starter roster, animated GIF cards, movement ownership, schema-6 profile identity, shared destructive warnings, and reset lifecycle |
| Change automatic progression saves, collection reload, startup save inspection, or overworld pose persistence | [`progression-autosave.md`](progression-autosave.md) | Schema-6 domain sections, legacy migration, startup suspension, checkpoint triggers, validation, and exact-pose restore behavior |
...
| Change Stretchman, the Adventure Menu, shops, loot boxes, money rewards, routes, gyms, the Champion challenge, or standalone-area authoring | [`adventure-menu-and-standalone-areas.md`](adventure-menu-and-standalone-areas.md) | Generic menu-NPC boundary, split domain ownership, catalog rules, static inherited area scenes, encounter resources, progression, and export checks |
