...
| Add an NPC action, change forward target selection, or modify the interaction HUD | [`interaction-hud.md`](interaction-hud.md) | RND target geometry, shared HUD input, behavior dispatch, and trainer/healer modes |
| Change the permanent player menu, Party/PC organization, bag management, or Pokedex browser | [`player-menu.md`](player-menu.md) | Shared HUD entry, modal ownership, collection/inventory APIs, GIF presentation, and regression coverage |
