...
| Change first-run starter selection, fresh-profile initialization, or full progress reset | [`starter-selection.md`](starter-selection.md) | Exact starter roster, animated GIF cards, movement ownership, schema-6 profile identity, destructive warnings, and reset lifecycle |
| Change automatic progression saves, collection reload, or overworld pose persistence | [`progression-autosave.md`](progression-autosave.md) | Schema-6 domain sections, legacy migration, checkpoint triggers, validation, and same-scene restore behavior |
