...
Its pack verifier requires `level_base.tscn`, exactly 49 standalone scenes, and
...
60 playable levels with one direct Player/camera/GameUI and no Runtime node.
The standalone scene test additionally requires all 49 valid, independently
loadable menu areas, static trainers and encounter resources, and the absence
