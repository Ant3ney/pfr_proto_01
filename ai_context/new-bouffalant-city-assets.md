...
- [`ground/`](../game/world/level_kits/terrain/new_bouffalant_city/ground/) is the canonical 2 × 2 m city-cobble kit. Use `ground_tile_mesh_library.tres` for the GridMap workflow; direct scene wrappers live under `ground/scenes/`.
...
- [`interiors/`](../game/world/levels/new_bouffalant_city/interiors/) retains the other eight city-connected scenes: City Hall, Rouge Tower, Miare Station, the garage, Gate Building, both tenant instances, and the museum. They inherit the interior level base and share reusable room, door, and lighting scenes. Miare Station owns the ordinary Stretchman resident instance, and the Gate Building's rear room owns the walk-through Route 0 door and safe return marker.
