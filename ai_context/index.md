...
| Implement or change music, battle starts, the battle REST service, dialogs, UI template callbacks, sequences, or player movement locks | [`runtime/index.md`](runtime/index.md) | Verified runtime ownership and lifecycle contracts for music, battle launch, the stateless battle API, dialog/UI, and sequences |
...
| Change or diagnose the styled Web loader, resumable asset cache, Netlify Web build, or Godot loader patch | [`web-loading.md`](web-loading.md) | Verified production/LAN loading lifecycle, generated-manifest, cache, recovery, and validation contracts |
